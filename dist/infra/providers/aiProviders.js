...
exports.AnthropicAIProvider = exports.MockAIProvider = void 0;
// ─── Mock Provider ────────────────────────────────────────────────────────────
const MOCK_RESPONSES = {
    iphone: {
        message: "O **iPhone 15 Pro** está com o melhor preço no Mercado Livre agora: **R$ 6.799** com 24% de desconto! É R$ 450 mais barato que a Amazon e inclui frete grátis.\n\n📊 **Análise de preço:** O preço histórico mais baixo foi R$ 6.200 — pode valer esperar a Black Friday caso não seja urgente.",
        productIds: ["1"],
        tips: [
    ...
    celular: {
        message: "Para custo-benefício, o **Xiaomi Redmi Note 13 Pro** está com 35% de desconto na Shopee — excelente câmera de 200MP por apenas R$ 1.299! Se tiver mais orçamento, o **Samsung Galaxy S24 Ultra** está R$ 1.500 mais barato que o normal na Amazon.",
        productIds: ["8", "2"],
        tips: [
    ...
    notebook: {
        message: "Para notebooks, temos ótimas opções! O **MacBook Air M3** é imbatível em desempenho e está 14% off na Amazon (R$ 9.499). Para Windows, o **Dell Inspiron i7** está 26% off no Mercado Livre por R$ 3.299 — excelente custo-benefício para trabalho.",
        productIds: ["3", "7"],
        tips: [
    ...
    ps5: {
        message: "O **PS5 Slim Digital** está com desconto incrível de 32% na Shopee: apenas **R$ 2.699**! Economize R$ 1.300 em relação ao preço original. Atenção: estoque costuma acabar rápido nesta faixa.",
        productIds: ["4"],
        tips: [
    ...
    tv: {
        message: "A **Samsung 55\" QLED 4K** está com 27% de desconto na Magazine Luiza por R$ 2.899! Tecnologia Quantum Dot com 144Hz é excelente para jogos e streaming. Economia de R$ 1.100 em relação ao preço cheio.",
        productIds: ["5"],
        tips: [
    ...
    fone: {
        message: "O **Sony WH-1000XM5** é o melhor cancelamento de ruído do mercado e está 31% off na Amazon por R$ 1.499! Perfeito para home office ou viagens. Economize R$ 700 no modelo top de linha.",
        productIds: ["6"],
        tips: [
...
class MockAIProvider {
    ...
    detectIntent(message) {
        ...
        if (msg.includes("iphone") || msg.includes("apple"))
            return "iphone";
        if (msg.includes("celular") || msg.includes("smartphone") || msg.includes("galaxy") || msg.includes("samsung") || msg.includes("xiaomi"))
            return "celular";
        if (msg.includes("notebook") || msg.includes("laptop") || msg.includes("computador") || msg.includes("pc") || msg.includes("macbook"))
            return "notebook";
        if (msg.includes("ps5") || msg.includes("playstation") || msg.includes("console") || msg.includes("game"))
            return "ps5";
        if (msg.includes("tv") || msg.includes("televisao") || msg.includes("televisão") || msg.includes("smart tv"))
            return "tv";
        if (msg.includes("fone") || msg.includes("headphone") || msg.includes("audio") || msg.includes("áudio") || msg.includes("sony"))
            return "fone";
        return "general";
    }
